    ...
    <div>
      ...
      >
        <Box  className='modal-box'>
         ...
         <h1 style={{fontSize:30,fontWeight:'bold'}}>Background</h1>
          ...
          <h1 style={{fontSize:30,fontWeight:'bold'}}>Position Summary</h1>
          <Typography id="keep-mounted-modal-description" sx={{ mt: 2 }}>
          The African Guarantee Fund (AGF) is a Pan-African non-bank financial institution founded by the
            Ministry of Foreign Affairs on behalf of the Government of Denmark through the Danish
          </Typography>
          <h1 style={{fontSize:30,fontWeight:'bold',paddingTop:15}}>Desirable qualifications, knowledge skills and experiences</h1>
            <ul>
            ...
            <h1 style={{fontSize:30,fontWeight:'bold'}}>Eligibility</h1>
          <Typography id="keep-mounted-modal-description" sx={{ mt: 2 }}>
          The position is open to bilingual French and English speakers who are from any African country.
          </Typography>

          <h1 style={{fontSize:30,fontWeight:'bold'}}> Applications</h1>
          <Typography id="keep-mounted-modal-description" sx={{ mt: 2 }}>
